...
@Component({
  selector: 'app-rdap-config-common-view',
  templateUrl: './rdap-config-common-view.component.html',
  styleUrls: ['./rdap-config-common-view.component.scss']
})
export class RdapConfigCommonViewComponent implements OnInit {
  formName: string;
  route: string;
  routeName: string;
  pageName : string;
